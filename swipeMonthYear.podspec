#
#  Be sure to run `pod spec lint swipeMonthYear.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "swipeMonthYear"
  s.version      = "1.0.1"
  s.summary      = "this is a lib for swipe datetime, year, month"
  ...
  s.description  = "This is a description, I will update later"

  s.homepage     = "https://github.com/annguyenlgg/swipeMonthYear"
  ...
  s.license      = { :type => "GNU General Public License", :file => "LICENSE.md" }
